...
function sendNotification(message)
{
    const settings = {
        ...
        processData: false,
        data: `{"app_id":"4795363c-9db9-4805-b9f3-1b258285b5b8","include_player_ids":["${user_id}"],"name":"Nueva orden de trabajo","url":"https://heroic-hotteok-9c4a32.netlify.app/","chrome_web_icon":"../icon.png","contents":{"en":"English or Any Language Message","es":"${message}"}}`
      };
    //   console.log("REQUEST:");
